...
public class SearchResponse {
    ...
    public SearchResponse(List<Map<String, Object>> response, Integer start, Integer end, SearchFilters filters) {
        I id = new I();
    ...
    private static boolean filter(KwicData data, SearchFilters filters) {
